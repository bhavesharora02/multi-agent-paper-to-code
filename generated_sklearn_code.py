...
M
    ...
    def __init__(self, **kwargs):
        ...
        if 'random forest' in 'deep learning'.lower():
            self.model = RandomForestClassifier(**kwargs)
        elif 'logistic' in 'deep learning'.lower():
...
class ica_1:
    ...
    def __init__(self, **kwargs):
        # Choose appropriate sklearn model based on algorithm name
        if 'random forest' in 'ica'.lower():
            self.model = RandomForestClassifier(**kwargs)
        elif 'logistic' in 'ica'.lower():
            self.model = LogisticRegression(**kwargs)
        else:
            # Default to Random Forest
            self.model = RandomForestClassifier(**kwargs)
...
class transformer_6:
    ...
    def __init__(self, **kwargs):
        # Choose appropriate sklearn model based on algorithm name
        if 'random forest' in 'transformer'.lower():
            self.model = RandomForestClassifier(**kwargs)
        elif 'logistic' in 'transformer'.lower():
            self.model = LogisticRegression(**kwargs)
        else:
            # Default to Random Forest
            self.model = RandomForestClassifier(**kwargs)
